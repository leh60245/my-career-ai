...
class JobCategory(Base, TimestampMixin):
    ...
    keywords: Mapped[list[str] | None] = mapped_column(ARRAY(String), nullable=True, comment="핵심 역량 키워드 리스트")
    ...
    children: Mapped[list["JobCategory"]] = relationship("JobCategory", back_populates="parent", lazy="select")
